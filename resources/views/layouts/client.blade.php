  ...
  <div class="w-screen font-dmsans bg-third border-b border-second">
    <nav class="cabin flex justify-between px-4 py-3 max-w-5xl mx-auto text-first">
      ...
      <div class="flex items-center max-md:hidden">
        <a href="#"><i class="ri-search-line text-xl px-4"></i></a>
        @auth
        <a href="{{ route('dashboard')}}"><i class="ri-user-fill text-xl px-4 border-r border-second"></i></a>
        @else
        <a href="{{ route('login') }}"><i class="ri-user-fill text-xl px-4 border-r border-second"></i></a>
        @endauth
        <a href="{{ route('panier') }}"><i class="ri-shopping-bag-2-line text-xl px-4 border-r border-second"></i></a>
