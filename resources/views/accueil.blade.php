...
@section('content')
    ...
    <div class="w-full bg-third">
      <div class="font-playfair grid md:grid-cols-2 max-md:grid-cols-1 justify-center align-center max-w-screen-2xl mx-auto text-first lg:py-8">
        ...
        <div class="flex items-center">
          <img src="{{ asset('images/composants/compressed/landing-redhead.png')}}"
    ...
    <div class="w-full bg-third text-black ">
      <div class="max-w-screen-2xl mx-auto grid lg:grid-cols-3 md:grid-cols-2 max-md:grid-cols-1 md:gap-4 place-items-center p-4">
        <img src="{{ asset('images/composants/compressed/landing-4women.png')}}" alt="4women" loading="lazy" class="object-cover object-center max-md:h-96 w-auto md:p-6 max-md:p-4">
