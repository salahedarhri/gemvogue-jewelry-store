...
<body class="bg-neutral-100 min-h-screen text-black">
  ...
  <div class="fixed left-0 top-0 w-64 h-full p-4 max-md:hidden bg-gradient-to-b from-secondDarker to-fourth">
    ...
    <ul class="font-dmsans">
      ...
      <li>
        <a href="{{route('admin.utilisateurs.index')}}" class="flex items-center py-2 px-4 text-whiteShade focus:bg-fourth focus:text-white rounded">
          <i class="ri-user-line mr-3 text-xl"></i>
          <span>Utilisateurs</span></a></li>
      <li>
        <a href="{{route('admin.bijoux.index')}}" class="flex items-center py-2 px-4 text-whiteShade focus:bg-fourth focus:text-white rounded">
          <i class="ri-vip-diamond-line mr-3 text-xl"></i>
          <span>Produits</span></a></li>
      <li>
        <a href="{{ route('admin.commandes.index')}}" class="flex items-center py-2 px-4 text-whiteShade focus:bg-fourth focus:text-white rounded">
          <i class="ri-shopping-bag-2-line mr-3 text-xl"></i>
          <span>Commandes</span></a></li>
      <li>
        <a href="{{ route('admin.messages.index')}}" class="flex items-center py-2 px-4 text-whiteShade focus:bg-fourth focus:text-white rounded">
          <i class="ri-chat-1-line mr-3 text-xl"></i>
          <span>Messages</span></a></li>
      <li>
        <a href="{{ route('admin.newsletters.index')}}" class="flex items-center py-2 px-4 text-whiteShade focus:bg-fourth focus:text-white rounded">
