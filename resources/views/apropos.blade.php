...
<div class="antialiased w-full bg-third pb-8">
    ...
    <div class="w-full">
        <div class="max-w-6xl mx-auto grid grid-cols-5 max-md:grid-cols-1 place-items-center">
            <div class="md:col-span-2 p-8 max-md:p-6">
                <img class="w-96 h-auto object-center object-cover aspect-square border-4 border-second shadow-xl" src="{{ asset('images/composants/shop (1).jpg')}}" alt="shop(1)">
            </div>

            <div class="md:col-span-3 flex flex-col gap-4 max-md:text-center justify-center text-black font-dmsans md:px-4 max-md:p-4 max-md:h-72">
    ...
    <div class="w-full bg-gradient-to-r from-second to-secondDarker shadow-xl">
        <div class="max-w-6xl mx-auto grid grid-cols-3 max-md:grid-cols-1 place-items-center">
            ...
            <div class="flex flex-col gap-4 justify-center max-md:text-center  md:col-span-2 text-third font-dmsans md:px-12 max-md:p-4 max-md:h-80">
    ...
    <div class="w-full">
        <div class="max-w-6xl mx-auto grid grid-cols-5 max-md:grid-cols-1 place-items-center">
            <div class="md:col-span-2 p-8 max-md:p-6">
                <img class="w-96 h-auto object-center object-cover aspect-square border-4 border-secondDarker shadow-xl" src="{{ asset('images/composants/shop (2).jpg')}}" alt="shop(1)">
            </div>

            <div class="md:col-span-3 flex flex-col gap-4 max-md:text-center justify-center text-black font-dmsans md:px-4 max-md:p-4 max-md:h-80">
    ...
    <div class="w-full bg-gradient-to-r from-fourth to-fourthDarker shadow-xl">
        <div class="max-w-6xl mx-auto grid grid-cols-3 max-md:grid-cols-1 place-items-center">
            ...
            <div class="flex flex-col justify-center gap-5 max-md:text-center md:col-span-2 text-third font-dmsans md:px-12 max-md:p-4 max-md:h-80">
            ...
            <div class="p-4 max-md:p-6">
                <img class="object-center object-cover w-80 h-auto border-4 border-third shadow-xl" src="{{ asset('images/composants/shop (3).jpg')}}" alt="shop(1)">
            </div>
